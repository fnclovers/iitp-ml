...
FileModel::FileModel(ObjectData &o) : AbstractMLModel(o) {}

FileModel::~FileModel() {}

void FileModel::init(CoReadPredictor *pp, uint64_t tlp) {
...
CoReadPrediction FileModel::readEntry(std::ifstream &predictionFile) {
...
void FileModel::inferenceDone(uint64_t, uint64_t tag) {
...
void FileModel::trainingDone(uint64_t, uint64_t tag) {
